    ...
    <div className="carbon-bg">
      <Row>
        ...
        <Col md={6}>
          ...
          <p className="paragraph">
            <span>Recyglo</span>, a leading waste management platform, is
            ...
            commitment to environmental sustainability, <span>Recyglo</span> has
      ...
      <Row>
        <Col md={6}>
          ...
          <p className="paragraph">
            <span>GHG Emission Reduction Measurement</span>: The report
          ...
          <p className="paragraph">
            <span>Net GHG Emissions</span>: By subtracting the GHG emissions
