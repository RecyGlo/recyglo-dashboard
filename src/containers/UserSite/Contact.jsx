            ...
            <Col md={8} lg={8} sm={6}>
              <Card className="contact-card">
                ...
                >
                  ...
                  <br />
                  <td>
                    <span className="sidebar__link-icon lnr lnr-pencil" />
                  </td>
                  <td>
                    At RecyGlo, we’re committed to providing environmentally
                    friendly recycling solutions to Myanmar, and Malaysia.
                    Founded in 2017, our mission is to process your materials in
                    a safe, non-hazardous manner — with an aim to keep the world
                    environmentally clean. We believe in promoting smart
                    recycling habits in order to achieve long-lasting results.
                  </td>
                  <br />
                  <span className="sidebar__link-icon lnr lnr-location" />
                  No. 253/257 (A), 11th Floor, Corner of 29th Street, Anawrahta
                  Road, Pabedan Township, Yangon.
                  <br />
                  <br />
                  <span className="sidebar__link-icon lnr lnr-envelope" />
                  <a
                    href="mailto:contact@recyglo.com"
                    style={{ color: "#4dbdb6" }}
                  >
                    contact@recyglo.com
                  </a>
                  ...
                  <a href="tel:+959404245800" style={{ color: "#4dbdb6" }}>
                    (+95) 9 404 245 800
                  </a>
                  <Card className="contact-inside">
                    ...
                    >
                      ...
                      very own social media pages. Additionally, use these to
                      ...
                      {/* <a
                        ...
                        style={{ color: "white" }}
                      >
                        <u>Click here to chat with us right now.</u>
                      </a> */}
                    </CardBody>
                  </Card>
                </CardBody>
