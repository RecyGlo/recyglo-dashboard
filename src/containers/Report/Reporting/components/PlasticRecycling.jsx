              ...
              <tr>
                ...
                >
                  ...
                  <div style={{ width: '-webkit-fit-content', margin: '5px auto' }}>
                    <img style={{ width: '250px' }} src={plastic2} alt="image2" height="300" />
                    <img style={{ width: '250px' }} src={plastic3} alt="image2" height="300" />
                  </div>
                </td>
                <td style={{
                  }}
                ...
                >
                  ...
                  <img
                    style={{
                      display: 'block', padding: '100px 10px', margin: '0 auto', width: '100px',
                    }}
                    src={plastic8}
                    alt="image1"
                  />
