  ...
  render() {
    ...
    return (
      <Container className="dashboard">
        <Row>
          <Col md={12}>
            <h3 className="page-title">Dashboard Testing 2</h3>
          </Col>
        </Row>
        <Row>
          {misc.dashboard && misc.growth_rate && misc.trend &&
            [
              ...
              (misc.dashboard.trainings &&
                <TotalTrainings trainings={misc.dashboard.trainings} />
              ),
              (misc.dashboard.logistics &&
                <TotalCollectionWays logistics={misc.dashboard.logistics} />
              ),
              (misc.dashboard.collectedWastes &&
                <TotalWasteCollections collectedWastes={misc.dashboard.collectedWastes} />
              ),
            ]
          }
